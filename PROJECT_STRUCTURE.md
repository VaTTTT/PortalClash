...
├── GEMINI.md               # Main instructions (Must remain at root for AI context loading)
...
- **`GEMINI.md`**: Design instructions, roster details, progression values, and guidelines. **IMPORTANT:** This file must remain in the root directory as it is parsed by the AI development assistant to load development constraints and guidelines.
